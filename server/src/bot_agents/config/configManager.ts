...
export class ConfigManager {
  private currentConfig: Record<TaskType, ModelConfig>;

  constructor() {
    this.currentConfig = this.loadConfig();
  }

  private loadConfig(): Record<TaskType, ModelConfig> {
    try {
  ...
  public getConfig(): Record<TaskType, ModelConfig> {
    return this.currentConfig;
  }

  public updateConfig(newConfig: Record<TaskType, ModelConfig>) {
  ...
  private saveConfig(config: Record<TaskType, ModelConfig>) {
    try {
